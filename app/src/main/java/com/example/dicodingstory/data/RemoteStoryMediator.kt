...
import com.example.dicodingstory.data.database.RemoteKeys
...
class RemoteStoryMediator (private val database: StoryDatabase,
    ...
    override suspend fun load(
        ...
        try {
            ...
            val responseData =
                apiService.getStoriesPage("Bearer $token", page, state.config.pageSize).listStory
